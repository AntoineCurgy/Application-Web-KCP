...
var KCP_ARBRE = (function () {
  ...
  var BW = 186, GAP = 20, H = 36, SPY = 52, Y0 = 82, RS = 40, SW = 162, GAPR = 32, PAD = 6;
  ...
  function dessine(svg, opts) {
    ...
    pos.forEach(function (p) {
      ...
      if (p.d.n) {
        var c = el('text', { x: p.x + BW - 12, y: p.y + 24, class: 'cnt', 'text-anchor': 'end' });
        c.textContent = p.d.n; g.appendChild(c);
      }
